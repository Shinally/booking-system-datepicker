/*! booking-system-datepicker 1.0 - Copyright 2021 Farina Anthony (http://anthonyfarina.eu) - https://github.com/Shinally/booking-system-datepicker - MIT */
var Picker = (function () {
    'use strict';
    ...
    var Picker = function Picker(input, options) {
        this._boundedEventHandlers = {};
        this.id = Picker.getNewId();
        ...
        this.closePeriods = opts.closePeriods || [];
        ...
        this.showCloseButton = opts.showCloseButton === undefined ? true : opts.showCloseButton;
        this.showClearDatesButton = opts.showClearDatesButton === undefined ? true : opts.showClearDatesButton;
        ...
        this.onClear = opts.onClear === undefined ? true : opts.onClear;
    ...
    Picker.prototype.addBoundedListener = function addBoundedListener (node, event, handler, capture) {
    ...
    Picker.prototype.removeAllBoundedListeners = function removeAllBoundedListeners (node, event) {
        if (node in this._boundedEventHandlers) {
    ...
    Picker.getNewId = function getNewId () {
        return ++idCounter;
    };

    Picker.prototype.setFechaI18n = function setFechaI18n () {
    ...
    Picker.prototype.getWeekDayNames = function getWeekDayNames () {
        var this$1 = this;
    ...
    Picker.prototype.getMonthDom = function getMonthDom (month) {
        // Get month DOM element
        return document.getElementById(this.getMonthTableId(month));
    };

    Picker.prototype.getMonthName = function getMonthName (m) {
        // Get month name
        return this.lang('month-names')[m];
    };

    Picker.prototype.getDatepickerId = function getDatepickerId () {
        // Get datepicker ID
        return 'datepicker-' + this.generateId();
    };

    Picker.prototype.getMonthTableId = function getMonthTableId (month) {
        // Get month table ID
        return 'month-' + month + '-' + this.generateId();
    };

    Picker.prototype.getCloseButtonId = function getCloseButtonId () {
        // Get close button ID
        return 'close-' + this.generateId();
    };

    Picker.prototype.getClearDatesButtonId = function getClearDatesButtonId () {
        //Get clear dates button id
        return 'clear-dates-' + this.generateId();
    };

    Picker.prototype.getTooltipId = function getTooltipId () {
        // Get close button ID
        return 'tooltip-' + this.generateId();
    };

    Picker.prototype.getNextMonth = function getNextMonth (month) {
        // Get next month date
    ...
    Picker.prototype.getPrevMonth = function getPrevMonth (month) {
    ...
    Picker.prototype.getDateString = function getDateString (date, format) {
    ...
    Picker.prototype.parseDate = function parseDate (date, format) {
        if ( format === void 0 ) format = this.format;
    ...
    Picker.prototype.init = function init () {
        ...
        //Parse close periods
        if(this.closePeriods.length > 0){
            this.parseClosePeriods();
        }
        ...
        this.isFirstClosePeriodDate = 0;

        // Holds last disabled date
        this.lastDisabledDate = false;
        this.lastClosePeriodDate = false;
    };

    Picker.prototype.addListeners = function addListeners () {
        var this$1 = this;
        ...
        if(this.showClearDatesButton) {
            document.getElementById(this.getClearDatesButtonId()).addEventListener('click', function (evt) {
                return this$1.clear(evt);
            });
        }
    ...
    Picker.prototype.generateId = function generateId () {
    ...
    Picker.prototype.createDom = function createDom () {
    ...
    Picker.prototype.createDatepickerDomString = function createDatepickerDomString () {
        var this$1 = this;
        ...
        if (this.showTopbar) {
            html += '<div class="datepicker__info datepicker__info--selected"><span class="datepicker__info datepicker__info--selected-label">' + this.lang('selected') + ' </span> <strong class="datepicker__info-text datepicker__info-text--start-day">...</strong>' +
        ...
        if(this.showClearDatesButton)
            html += '<button type="button" id="' + this.getClearDatesButtonId() + '" class="datepicker__clear-dates-button">' + this.lang('clear') + '</button>';
        if(this.showCloseButton)
    ...
    Picker.prototype.showMonth = function showMonth (date, month) {
    ...
    Picker.prototype.createMonthDomString = function createMonthDomString (_date) {
        var this$1 = this;
        ...
        for (var week = 0; week < 6; week++) {
            ...
            for (var i$2 = 0; i$2 < 7; i$2++) {
                ...
                // Day between close period dates and the last day
                // before close period date
                var isDayBeforeClosePeriodDate = false;
                ...
                if (_day$2.valid || _day$2.type === 'visibleMonth') {
                    ...
                    if (this$1.closePeriods.length > 0) {
                        // Check if this day is between two disabled dates
                        // and disable it if there are not enough days
                        // available to select a valid range
                        var limit2 = this$1.getClosestDatesClosePeriods(_day$2.date);

                        if (limit2[0] && limit2[1]) {
                            if (this$1.compareDay(_day$2.date, limit2[0]) && (this$1.countDays(limit2[0], limit2[1]) - 2) > 0) {
                                var daysBeforeNextClosePeriodDate = this$1.countDays(limit2[1], _day$2.date) - 1;
                                var daysAfterPrevClosePeriodDate = this$1.countDays(_day$2.date, limit2[0]) - 1;

                                if (this$1.selectForward && daysBeforeNextClosePeriodDate < this$1.minDays) {
                                    _day$2.valid = false;
                                } else if (!this$1.selectForward && daysBeforeNextClosePeriodDate < this$1.minDays && daysAfterPrevClosePeriodDate < this$1.minDays) {
                                    _day$2.valid = false;
                                }

                                if (!_day$2.valid && daysBeforeNextClosePeriodDate === 2) {
                                    isDayBeforeClosePeriodDate = true;
                                }
                            }
                        }

                        if (this$1.closePeriods.indexOf(dateString) > -1) {
                            _day$2.valid = false;
                            isClosePeriod = true;

                            this$1.isFirstClosePeriodDate++;

                            // Store last disabled date for later
                            this$1.lastClosePeriodDate= _day$2.date;
                        } else {
                            this$1.isFirstClosePeriodDate = 0;
                        }

                        // First day after a disabled day
                        if (_day$2.valid && this$1.lastClosePeriodDate && this$1.compareDay(_day$2.date, this$1.lastClosePeriodDate) > 0 && this$1.countDays(_day$2.date, this$1.lastClosePeriodDate) === 2) {
                            isFirstEnabledDate = true;
                        }
                    }
                ...
                var classes = [
                    ...
                    isClosePeriod ? 'datepicker__month-day--disabled' : '',
    ...
    Picker.prototype.openDatepicker = function openDatepicker () {
        var this$1 = this;
    ...
    Picker.prototype.closeDatepicker = function closeDatepicker () {
    ...
    Picker.prototype.autoclose = function autoclose () {
    ...
    Picker.prototype.documentClick = function documentClick (evt) {
    ...
    Picker.prototype.datepickerHover = function datepickerHover (evt) {
    ...
    Picker.prototype.datepickerMouseOut = function datepickerMouseOut (evt) {
    ...
    Picker.prototype.checkAndSetDefaultValue = function checkAndSetDefaultValue () {
    ...
    Picker.prototype.setDateRange = function setDateRange (date1, date2) {
    ...
    Picker.prototype.showSelectedDays = function showSelectedDays () {
        var this$1 = this;
    ...
    Picker.prototype.showSelectedInfo = function showSelectedInfo () {
        ...
        if (this.start && this.end) {
            ...
            if(count > 1) {
                ...
                dateRangeValue$1 = this.getDateString(new Date(this.start)) + this.separator + this.getDateString(new Date(this.end));
    ...
    Picker.prototype.dayClicked = function dayClicked (day) {
    ...
    Picker.prototype.isValidDate = function isValidDate (time) {
        ...
        if (this.start && !this.end) {
            ...
            //Check close periods
            if (this.closePeriods.length > 0) {
                var limit2 = this.getClosestDatesClosePeriods(new Date(parseInt(this.start, 10)));
    ...
    Picker.prototype.checkSelection = function checkSelection () {
        var this$1 = this;
    ...
    Picker.prototype.addDays = function addDays (date, days) {
        // Add xx days to date
    ...
    Picker.prototype.countDays = function countDays (start, end) {
        // Return days between two dates
        return Math.abs(this.daysFrom1970(start) - this.daysFrom1970(end)) + 1;
    };

    Picker.prototype.compareDay = function compareDay (day1, day2) {
    ...
    Picker.prototype.compareMonth = function compareMonth (month1, month2) {
    ...
    Picker.prototype.daysFrom1970 = function daysFrom1970 (t) {
        // Get days from 1970
        return Math.floor(this.toLocalTimestamp(t) / 86400000);
    };

    Picker.prototype.toLocalTimestamp = function toLocalTimestamp (t) {
    ...
    Picker.prototype.printAttributes = function printAttributes (obj) {
    ...
    Picker.prototype.goToNextMonth = function goToNextMonth (e) {
    ...
    Picker.prototype.goToPreviousMonth = function goToPreviousMonth (e) {
    ...
    Picker.prototype.isSingleMonth = function isSingleMonth () {
        // Check if the second month is visible
        return !this.isVisible(this.getMonthDom(2));
    };

    Picker.prototype.isMonthOutOfRange = function isMonthOutOfRange (month) {
        var _m = new Date(month.valueOf());
    ...
    Picker.prototype.disableNextPrevButtons = function disableNextPrevButtons () {
    ...
    Picker.prototype.topBarDefaultText = function topBarDefaultText () {
        // Return early if the top bar is disabled
        if (!this.showTopbar) {
            return;
        }
    ...
    Picker.prototype.topBarErrorText = function topBarErrorText (bar, errorText, errorValue) {
        if (!this.showTopbar) {
            return;
        }
    ...
    Picker.prototype.updateSelectableRange = function updateSelectableRange () {
        var this$1 = this;
    ...
    Picker.prototype.dayHovering = function dayHovering (day) {
        var this$1 = this;
            ...
            if (this.start && !this.end) {
                ...
                if (this.hoveringTooltip) {
                    if (typeof this.hoveringTooltip === 'function') {
                        ...
                        let label = nights === 1 ? this.lang('night') : this.lang('nights');
                        tooltip += (nights) + ' ' + label  + '\n';
                    }
                    else if (this.hoveringTooltip === true && nights === 0 && this.minNights > 1) {
                        tooltip += Translator.trans('calendar.options.label.info-minimum-stay', {'num_nights': this.minNights})  + '\n';
                    }
                }
            }
        } else{
            if (this.hoveringTooltip && this.hasClass(day, 'datepicker__month-day--checkout-enabled')) {
                tooltip += Translator.trans('calendar.options.label.checkin-disabled')  + '\n';
            }
            if (this.start && !this.end) {
                let nights = this.countDays(hoverTime, this.start) - 1;
                if (this.hoveringTooltip === true && hoverTime > this.start && nights < this.minNights && this.minNights > 1) {
                    tooltip += Translator.trans('calendar.options.label.info-minimum-stay', {'num_nights': this.minNights}) + '\n';
                }
            }
        }
    ...
    Picker.prototype.clearHovering = function clearHovering () {
        var this$1 = this;
    ...
    Picker.prototype.clearSelection = function clearSelection () {
        var this$1 = this;
    ...
    Picker.prototype.parseDisabledDates = function parseDisabledDates () {
        var this$1 = this;
    ...
    Picker.prototype.parseClosePeriods = function parseClosePeriods () {
        var this$1 = this;

        // Sort close periods dates and store it in property
        var _tmp = [];
        this.setFechaI18n();
        for (var i = 0; i < this.closePeriods.length; i++) {
            _tmp[i] = fecha.parse(this$1.closePeriods[i], 'YYYY-MM-DD');
        }
        ...
        this.closePeriodsTime = _tmp;
    };

    Picker.prototype.getClosestDates = function getClosestDates (x) {
        var this$1 = this;
    ...
    Picker.prototype.getClosestDatesClosePeriods = function getClosestDatesClosePeriods(x){
        var this$1 = this;
        ...
        // If the day is before the first disabled date return early
        if (x < this.closePeriodsTime[0]) {
            dates = [false, this.closePeriodsTime[0]];
            // If the day is after the last disabled date return early
        } else if (x > this.closePeriodsTime[this.closePeriodsTime.length - 1]) {
            dates = [this.closePeriodsTime[this.closePeriodsTime.length - 1], false];
            // Otherwise calculate the closest dates
        } else {
            var bestPrevDate = this.closePeriodsTime.length;
            var bestNextDate = this.closePeriodsTime.length;
            var maxDateValue = Math.abs((new Date(0, 0, 0)).valueOf());
            var bestPrevDiff = maxDateValue;
            var bestNextDiff = -maxDateValue;
            var currDiff = 0;
            ...
            for (i = 0; i < this.closePeriodsTime.length; ++i) {
                currDiff = x - this$1.closePeriodsTime[i];
            ...
            if (this.closePeriodsTime[bestPrevDate]) {
                dates[0] = this.closePeriodsTime[bestPrevDate];
            }

            if (typeof this.closePeriodsTime[bestPrevDate] === 'undefined') {
                dates[1] = false;
            }
            else {
                dates[1] = this.closePeriodsTime[bestNextDate];
            }
        }
    ...
    Picker.prototype.lang = function lang (s) {
        // Return i18n string
        return (s in this.i18n) ? this.i18n[s] : '';
    };

    Picker.prototype.emptyElement = function emptyElement (element) {
    ...
    Picker.prototype.classRegex = function classRegex (c) {
        return new RegExp('(^|\\s+)' + c + '(\\s+|$)');
    };

    // Check if an element has a class
    Picker.prototype.hasClass = function hasClass (el, c) {
        return this.classRegex(c).test(el.className);
    };

    // Add a class to the element
    Picker.prototype.addClass = function addClass (el, c) {
    ...
    Picker.prototype.removeClass = function removeClass (el, c) {
        el.className = el.className.replace(this.classRegex(c), ' ');
    };

    Picker.prototype.isVisible = function isVisible (element) {
        // Check if a DOM element is visible
        return (element.offsetWidth || element.offsetHeight || element.getClientRects().length);
    };

    Picker.prototype.slideDown = function slideDown (element, speed) {
    ...
    Picker.prototype.slideUp = function slideUp (element, speed) {
        // Slide up an element
        var h = element.getBoundingClientRect().height;
        element.style.height = h + 'px';
        this.recalc(element.offsetHeight);
    ...
    Picker.prototype.recalc = function recalc (element) {
        // Force browser recalculation
        return element.offsetHeight;
    };

    Picker.prototype.isTouchDevice = function isTouchDevice () {
    ...
    Picker.prototype.getDatePicker = function getDatePicker () {
        return this.datepicker;
    };

    Picker.prototype.setRange = function setRange (d1, d2) {
    ...
    Picker.prototype.clear = function clear () {
        this.clearSelection();
    };

    Picker.prototype.getNights = function getNights () {
        var count = 0;
